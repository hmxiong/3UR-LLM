...
if __name__=="__main__":
    ...
    golds = json.load(open(os.path.join('/13390024681/3D/3D-LLM/data/ScanQA/ScanQA_v1.0_val.json')))
    ...
    pc_feat_root = "/13390024681/3D/LAMM/data/3D_Finetune/scannet_data"
