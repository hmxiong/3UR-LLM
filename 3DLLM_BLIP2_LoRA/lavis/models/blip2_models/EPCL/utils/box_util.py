...
def generalized_box3d_iou_tensor(
    ...
    enclosing_vols = enclosing_box3d_vol(corners1, corners2).clamp(min=EPS)
    ...
    if torch.isnan(gious).any():
        print("gious",gious)
        print("union_vols",union_vols)
        print("vols1",vols1)
        print("vols2",vols2)
        print("inter_vols",inter_vols)
        print("good_boxes",good_boxes)
        print("enclosing_vols",enclosing_vols)
