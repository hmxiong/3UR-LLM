...
class Blip2Base(BaseModel):
    ...
    @classmethod
    def init_Qformer(cls, num_query_token, vision_width, use_3d=False, cross_attention_freq=2):
        encoder_config = BertConfig.from_pretrained("/13390024681/3D/3D-LLM/data/bert-base-uncased")
        encoder_config.encoder_width = vision_width
        encoder_config.use_3d = use_3d
        # insert cross-attention layer every other block
        encoder_config.add_cross_attention = True
        encoder_config.cross_attention_freq = cross_attention_freq # cross attention freq
