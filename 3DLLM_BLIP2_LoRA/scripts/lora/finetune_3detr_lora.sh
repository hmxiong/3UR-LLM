...
cd /13390024681/3D/3D-LLM/3DLLM_BLIP2-LoRA

conda activate 3d_llm

python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path lavis/projects/blip2/train/lora/finetune_scanqa_3detr_lora.yaml