...
python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path lavis/projects/blip2/train/3detr_concate/finetune_scanqa_3detr_concate_only_scannet.yaml