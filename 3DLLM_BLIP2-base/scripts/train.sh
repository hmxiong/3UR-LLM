...
# cd /13390024681/3D/3D-LLM/3DLLM_BLIP2-base/calculate_scores

# python calculate_score_scanqa.py --folder /13390024681/3D/3D-LLM/3DLLM_BLIP2-base/lavis/output/BLIP2/3DQA/20231102024 --epoch 3
